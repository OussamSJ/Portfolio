  ...
  return (
    <motion.div
      className={`relative mb-10 border-gray-300
        ${isRight ? "pl-10 border-l-2 text-left" : "pr-10 border-r-2 text-right ml-auto"}
      `}
    ...
    >
      <div
        className={`absolute top-0 w-6 h-6 bg-primary rounded-full border-4 border-primary shadow 
