                ...
                <Card.Body>
                    <Card.Text>
                        <p className="text-gray-700 text-2xl p-10  mg-auto ">
                            ...
                            Côté frontend, l'application est développée avec Angular 16+ et utilise la bibliothèque Bootstrap pour offrir une expérience utilisateur moderne et responsive. </p><br />
                        <p className="text-gray-700 text-2xl p-10  mg-auto ">
                            ...
                            Le backend, quant à lui, est bâti avec Spring Boot et met en œuvre une API RESTful sécurisée par Spring Security avec authentification via JSON Web Tokens (JWT). L’accès aux données est géré grâce à Spring Data JPA et Hibernate, avec une base de données relationnelle MySQL. <br />Une documentation interactive de l’API est disponible via Swagger, facilitant l’intégration et les tests. </p><br />
                        <p className="text-gray-700 text-2xl p-10  mg-auto ">
