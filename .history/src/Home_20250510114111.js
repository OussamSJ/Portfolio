...
<div className="text-right max-w-md mt-10 md:mt-30">
  ...
  <button className="z-0 bg-transparent  border border-white text-white font-bold py-2 px-6 mr-12 rounded shadow hover:bg-white hover:text-transparent transition">
