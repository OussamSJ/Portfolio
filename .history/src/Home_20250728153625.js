...
const Home = () => {
  ...
  return (
    <div className="Home">
      ...
      <section className="my-12">
        <h2 className="text-4xl font-bold mb-4 text-center mt-20">Mes Compétences</h2>
        <div className="relative top-1/2 w-1/3 mx-auto mb-10 h-0.5 bg-white transform -translate-y-1/2 z-0 hidden sm:block" />

        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
          <div className="p-4 bg-gray-100 rounded shadow flex items-center justify-center h-24">
            <img src="Kotlin.png" alt="React" className="h-12" />
          </div>
          <div className="p-4 bg-gray-100 rounded shadow flex items-center justify-center h-24">
            <img src="/images/java.png" alt="Java" className="h-12" />
          </div>
          <div className="p-4 bg-gray-100 rounded shadow flex items-center justify-center h-24">
            <img src="/images/springboot.png" alt="Spring Boot" className="h-12" />
          </div>
          <div className="p-4 bg-gray-100 rounded shadow flex items-center justify-center h-24">
            <img src="/images/sql.png" alt="SQL" className="h-12" />
          </div>
        </div>
      </section>
