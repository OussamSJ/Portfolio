      ...
      <div className="max-w-7xl mx-auto">
       ...
       {/* Call to Action */}
        ...
        >
          ...
          <a
            href="#contact"
            className="inline-block bg-white text-primary font-bold py-3 px-8 rounded-lg hover:bg-transparent hover:text-white transition-colors duration-300 shadow-xl"
          >
            Me contacter      
          </a>
        </motion.div>
