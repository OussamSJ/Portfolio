...
>
        ...
        <div className="text-center mt-12 bg-white p-8 rounded-lg shadow-lg">
          ...
          <a
            href="#contact"
            className="inline-block bg-primary text-white font-bold py-3 px-8 rounded-lg hover:bg-blue-900 transition- duration-300 shadow-lg hover:text-ellipsis hover:shadow-xl"
          >
            Lancer mon projet
          </a>
        </div>
