...
export default function Projet1() {
    return (
        <div className="relative w-full max-w-6xl mx-auto py-auto px-auto mt-10 mb-10">
            ...
            <Card>
                ...
                <Card.Body>
                    <Card.Text>
                        ...
                        <p className="text-gray-700 text-2xl p-10  mg-auto ">
                        <img src="/github.svg" alt="GitHub"></img> <Link to="https://github.com/OussamSJ/Angular-PMT-FrontEnd" className="text-blue-500 hover:underline">github.com/OussamSJ/Pmt</Link></p>
