...
Côté frontend, l'application est développée avec Angular 16+ et utilise la bibliothèque Bootstrap pour offrir une expérience utilisateur moderne et responsive. <br />La gestion des formulaires repose sur des formulaires réactifs avec une validation dynamique. Le frontend communique avec l’API REST du backend, tout en assurant une navigation fluide de type Single Page Application.

Le backend, quant à lui, est bâti avec Spring Boot et met en œuvre une API RESTful sécurisée par Spring Security avec authentification via JSON Web Tokens (JWT). L’accès aux données est géré grâce à Spring Data JPA et Hibernate, avec une base de données relationnelle MySQL. <br />Une documentation interactive de l’API est disponible via Swagger, facilitant l’intégration et les tests. <br />
...
Ce projet met également en avant une architecture modulaire, une gestion sécurisée des accès, et une scalabilité assurée par une conception pensée et testée pour l’extension (Docker-ready, CI/CD avec GitHub Actions). Le design épuré et responsive rend l'application accessible sur tous les types d’appareils, du desktop au mobile.
 ...
 <br />Le code source complet est accessible sur le lien GitHub ci-dessous. Ce projet reflète mon expertise en développement full-stack moderne et ma capacité à concevoir des solutions professionnelles, sécurisées et orientées utilisateur.
                        </p>
