  ...
  return (
    <section className="my-20 px-4py-16">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-4xl font-bold mb-4 text-center">Mon Processus de Travail</h2>
              ...
              >
                ...
                <div className={`w-full lg:w-5/12 ${isEven ? 'lg:text-right' : 'lg:text-left'}`}>
                  <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
                    ...
                    <div>
                      <div
  className={`flex mb-4 ${index % 2 === 0 ? "justify-end" : "justify-start"} ${isEven ? 'lg:text-right' : ''}`}>
                      <p className="font-semibold text-gray-700 mb-2">
                        <Icon name="file alternate" /> Livrables :
                      </p>
                      </div>
                      <ul className={`text-sm text-gray-600 space-y-1 ${isEven ? 'lg:text-right' : ''}`}>
        ...
        <div className="text-center mt-12 bg-white p-8 rounded-lg shadow-lg">
          ...
          <a
            href="#contact"
            className="inline-block bg-primary text-white font-bold py-3 px-8 rounded-lg hover:bg-blue-900 transition- duration-300 shadow-lg hover:text-white hover:shadow-xl"
          >
            Lancer mon projet
          </a>
        </div>
