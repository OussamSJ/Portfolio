        ...
        <div className="relative max-w-6xl mx-auto py-auto px-auto mt-10 mb-10">
            ...
            <Card.Body>
                ...
                <p className="text-gray-700 text-2xl p-10  mg-auto "></p>
                     ...
                     <img 
                    src="/github.svg" 
                    alt="GitHub logo, a stylized cat with a friendly expression, representing the GitHub platform for hosting and sharing code repositories"
                /> 
                <a>
                    <Link to="https://github.com/OussamSJ/Angular-PMT-FrontEnd" className="text-blue-500 hover:underline">
                    github.com/OussamSJ/Pmt
                    </Link>
                </a> 
