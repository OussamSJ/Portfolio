    ...
    <div className="Home">
      ...
      <section className="my-12 ">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
          ...
          <div
            className="p-4 bg-gray-100 rounded shadow bg-no-repeat bg-center bg-contain h-32 flex items-end justify-center" style={{ backgroundImage: "url('/images/kotlin.png')" }}>
            <span className="bg-white bg-opacity-75 px-2 py-1 rounded text-sm">Kotlin</span>
          </div>
        </div>
      </section>
