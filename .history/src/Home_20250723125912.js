    ...
    <div className="Home">
      ...
      <section className="my-12 ">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
          ...
          <div
            className="p-4 bg-gray-100 rounded shadow bg-no-repeat bg-center bg-contain h-32 flex items-end justify-center text-sm font-semibold"
            style={{ backgroundImage: "url('/images/kotlin.png')" }}
          >
            Kotlin
          </div>
        </div>
