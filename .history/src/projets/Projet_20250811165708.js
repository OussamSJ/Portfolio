...
export const projets = [
    ...
    {
        id: '3',
        titre: 'Machine Learning - Prédire le Prix de Vente',
        description: 'Améliorer la précision des estimations afin d’aider à la prise de décision pour la mise en vente, optimiser les marges, et anticiper les tendances du marché immobilier.',
...
export default function Projet() {
    return (
        <div className="relative max-w-6xl mx-auto py-auto px-auto mt-10 mb-10">
            ...
            <Card>
                <Card.Img variant="top" className=" w-200 h-80 mx-auto" src="couverture-portfolio.png" />
                <Card.Body>
                    <Card.Text>
