        ...
        <div className="relative max-w-6xl mx-auto py-auto px-auto mt-10 mb-10">
            ...
            <Card>
                <Card.Img
                    ...
                    src="/machinelearning_project.png"
                    alt="Logo du projet Machine Learning"
                />
                <Card.Body>
                    {/* Remplacer Card.Text par un div */}
                    <div>
                        ...
                        <div className="text-gray-700 text-2xl p-10 mg-auto">
                            <strong>Technologies et outils :</strong> Python, Pandas, NumPy, Scikit-learn, Flask pour l’API, Matplotlib, Seaborn, et Google Colab.
                        </div>
                        ...
                        <div className="text-gray-700 text-2xl p-10 mb-20 mg-auto">
                            ...
                            >
                                github.com/OussamSJ/Machine_Learning-Prix_De_Vente_Immobilier
                            </Link>
                        </div>
