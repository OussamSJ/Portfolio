        ...
        <Card.Body>
          <div>
            <div className="text-gray-700 text-2xl p-10 mg-auto">
              ...
              <strong> refonte d’une plateforme de vente de jeux de société en ligne</strong>. L’objectif principal était de concevoir et de développer une nouvelle architecture backend
            ...
            <div className="text-gray-700 text-2xl p-10 mg-auto">
              ...
              une gestion des rôles et permissions. Des tests unitaires et d’intégration ont été développés avec <strong>JUnit et MockMvc</strong> afin de
              garantir la fiabilité et la non-régression du code. Une attention particulière a été portée à la <strong>qualité du code, la couverture de tests</strong> et
            ...
            <div className="text-gray-700 text-2xl p-10 mb-20 mg-auto">
              <img
                src="/github.svg"
                alt="GitHub"
              ...
              />
              <a
                href="https://github.com/OussamSJ/GameUp-API-Spring"
