            ...
            <Card.Body>
                ...
                <p className="text-gray-700 text-2xl p-10  mg-auto ">
                    Le code source complet est accessible sur le lien GitHub ci-dessous. Ce projet reflète mon expertise en développement full-stack moderne et ma capacité à concevoir des solutions professionnelles, sécurisées et orientées utilisateur.
                        ...
                        <img src="/github.svg" alt="GitHub" className="w-10 h-10 inline-block"></img>frontend : <a><Link to="https://github.com/OussamSJ/Angular-PMT-FrontEnd" className="text-blue-500 hover:underline">github.com/OussamSJ/Pmt</Link> </a> <br/>
                         <img src="/github.svg" alt="GitHub" className="w-10 h-10 inline-block"></img>backend : <a><Link to="https://github.com/OussamSJ/Spring-PMT-BackEnd" className="text-blue-500 hover:underline">github.com/OussamSJ/Pmt</Link> </a>
