            ...
            <Card>
                ...
                <Card.Body>
                    <Card.Text>
                        ...
                        <p className="text-gray-700 text-2xl p-10 mg-auto">
                            <strong>Technologies et outils :</strong> Python, Pandas, NumPy, Scikit-learn, Matplotlib, Seaborn, et Google Colab pour l’expérimentation et la visualisation. Les algorithmes testés incluent la régression linéaire, les forêts aléatoires, et les modèles de gradient boosting.
                        </p>
                        <p className="text-gray-700 text-2xl p-10 mg-auto">
