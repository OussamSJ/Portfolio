            ...
            <Card>
                ...
                <Card.Body>
                    <Card.Text>
                        ...
                        <p className="text-gray-700 text-2xl p-10 mg-auto">
                            <strong>Technologies et outils :</strong> Python, Pandas, NumPy, Scikit-learn, Matplotlib, Seaborn, et Jupyter Notebook pour l’expérimentation et la visualisation. Les algorithmes testés incluent la régression linéaire, les forêts aléatoires, et les modèles de gradient boosting.
                        </p>
                        <p className="text-gray-700 text-2xl p-10 mg-auto">
                            <strong>Méthodologie :</strong> Une démarche CRISP-DM a été adoptée, comprenant l’exploration des données, l’ingénierie des variables (feature engineering), le traitement des valeurs manquantes, la sélection de variables pertinentes, et l’optimisation des hyperparamètres via validation croisée.
                        </p>
                        <p className="text-gray-700 text-2xl p-10 mg-auto">
                            <strong>Enjeux :</strong> Améliorer la précision des estimations afin d’aider à la prise de décision pour la mise en vente, optimiser les marges, et anticiper les tendances du marché immobilier. Ce projet illustre mes <strong>compétences en machine learning appliqué</strong>, mon savoir-faire en manipulation de données complexes, et ma capacité à transformer des insights en solutions concrètes.
                        </p>
