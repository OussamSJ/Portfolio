            ...
            <Card>
                ...
                <Card.Body>
                    <Card.Text>
                        ...
                        <p className="text-gray-700 text-2xl p-10 mg-auto">
                            <strong>API :</strong> Une API REST a été conçue pour exposer le modèle et permettre des prédictions en temps réel à partir de données clients. Cette API facilite l’intégration du modèle dans des applications externes ou des systèmes de gestion immobilière.
                        </p>
                        <p className="text-gray-700 text-2xl p-10 mg-auto">
                            <strong>Technologies et outils :</strong> Python, Pandas, NumPy, Scikit-learn, Flask pour l’API, Matplotlib, Seaborn, et Jupyter Notebook pour l’expérimentation et la visualisation.
                        </p>
                        <p className="text-gray-700 text-2xl p-10 mg-auto">
