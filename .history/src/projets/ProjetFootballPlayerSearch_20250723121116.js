            ...
            <Card>
                ...
                <Card.Body>
                    <Card.Text>
                        ...
                        <p className="text-gray-700 text-2xl p-10  mg-auto ">
                            <img src="/github.svg" alt="GitHub" className="w-10 h-10 inline-block"></img>frontend : <a><Link to="https://github.com/OussamSJ/FootballPlayerSearch" className="text-blue-500 hover:underline">github.com/OussamSJ/FootballPlayerSearch</Link> </a> <br/></p>
