  ...
  return (
    <div className="relative max-w-6xl mx-auto py-auto px-auto mt-10 mb-10">
      <h1 className="text-3xl font-bold mb-8 text-center p-8">
        GameUp API – Refonte d’une architecture logicielle et intégration d’un système de recommandation
      </h1>
      <Card>
        <Card.Img
          variant="top"
          className="w-200 h-80 mx-auto"
          src="/gameup_api_project.png"
        ...
        <Card.Body>
          <Card.Text>
            ...
            <p className="text-gray-700 text-2xl p-10 mg-auto">
              <strong>Enjeux et objectifs :</strong>  
              - Repartir d’une base de code existante défaillante pour concevoir une <strong>API REST modulaire et maintenable</strong>.  
              - Garantir la <strong>sécurité des accès</strong> et la gestion des rôles (client / administrateur).  
              - Mettre en œuvre un <strong>système de recommandation de jeux</strong> personnalisé en interaction avec une API Python.  
              - Respecter les <strong>principes SOLID</strong> et les bonnes pratiques d’architecture logicielle.  
