            ...
            <Card>
                ...
                <Card.Body>
                    <Card.Text>
                        ...
                        <p className="text-gray-700 text-2xl p-10 mg-auto">
                            <strong>Méthodologie :</strong> Démarche CRISP-DM comprenant exploration et nettoyage des données, traitement des valeurs manquantes, sélection de variables pertinentes, optimisation des hyperparamètres via validation croisée.
                        </p>
                        <p className="text-gray-700 text-2xl p-10 mg-auto">
