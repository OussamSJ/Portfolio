...
export default function Projet_Football_Player_Search() {
    return (
        <div className="relative max-w-6xl mx-auto py-auto px-auto mt-10 mb-10">
            <h1 className="text-3xl font-bold mb-8 text-center p-8">Projet: Football Player Search</h1>
            <Card>
                <Card.Img
                    variant="top"
                ...
                <Card.Body>
                    <Card.Text>
                        ...
                        <p className="text-gray-700 text-2xl p-10 mg-auto">
                            Ce projet met en avant une architecture modulaire et scalable, pensée pour évoluer facilement (ajout de favoris, stockage local, authentification, ou notifications push). Il reflète également une attention particulière portée à l’ergonomie et à l’expérience utilisateur sur mobile.
                        </p>
                        <p className="text-gray-700 text-2xl p-10 mg-auto">
                            Le code source complet est disponible sur le lien GitHub ci-dessous. Ce projet témoigne de mes compétences en développement mobile Android moderne avec Kotlin, de ma capacité à intégrer des APIs REST tierces, et de ma volonté de construire des applications performantes, intuitives et professionnelles.
                        </p>
                        ...
                        <p className="text-gray-700 text-2xl p-10  mg-auto ">
                            ...
                            <img src="/github.svg" alt="GitHub"></img> <a><Link to="https://github.com/OussamSJ/FootballPlayerSearch" className="text-blue-500 hover:underline">github.com/OussamSJ/Pmt</Link></a> </p>
