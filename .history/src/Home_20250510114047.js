...
<div className="text-right max-w-md mt-10 md:mt-30">
  ...
  <button className="bg-transparent z-10 border border-white text-white font-bold py-2 px-6 mr-12 rounded shadow hover:bg-white hover:text-transparent transition">
