    ...
    return (
      <>
        ...
        <nav className="navbar">
          ...
          <div className="links desktop-only">
            <Menu secondary>
              ...
              {/* Projets : MenuItem identique aux autres + petite flèche séparée */}
              <div
              ...
              >
                ...
                />
                 <button
                  className={`dropdown-caret-btn${projetDropdownOpen ? ' open' : ''}`}
                  onClick={this.toggleProjetDropdown}
                  aria-haspopup="true"
                  aria-expanded={projetDropdownOpen}
                  aria-label="Sous-menu projets"
                >
                  <a href="https://img.icons8.com/?size=100&id=101363&format=png&color=000000" style={{ display: 'block', color: 'grey', width: '100%', height: '100%' }} onClick={(e) => e.preventDefault()} />
                </button>
        ...
        >
          ...
          {/* Projets mobile : lien vers /projet + flèche accordéon indépendante */}
