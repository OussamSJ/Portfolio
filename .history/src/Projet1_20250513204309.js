            ...
            <Card>
                ...
                <Card.Body>
                    <Card.Text>
                        ...
                        <p className="text-gray-700 text-2xl p-10  mg-auto ">
                        <img src="/github.svg" alt="GitHub"><a><Link to="https://github.com/OussamSJ/Angular-PMT-FrontEnd" className="text-blue-500 hover:underline">github.com/OussamSJ/Pmt</Link></a></img> </p>
