...
- Section Exp. professionnelle
- Section contact (formulaire ou lien LinkedIn/email)
...
```bash
# Clone le dépôt
git clone https://github.com/OussamSJ/Portfolio.git

# Ouvre le projet dans ton éditeur
cd Portfolio
